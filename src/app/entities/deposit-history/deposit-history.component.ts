...
export class DepositHistoryComponent implements OnInit {
    ...
    gridOptions = {
        columnDefs: [
            ...
            { headerName: 'Debit', field: 'debit', width: 125, cellStyle: {textAlign: 'right'},
            editable: false, valueFormatter: this.currencyFormatter },
            { headerName: 'Credit', field: 'credit', width: 125, cellStyle: {textAlign: 'right'},
            editable: false, valueFormatter: this.currencyFormatter },
            { headerName: 'Balance', field: 'balance', width: 125, cellStyle: {textAlign: 'right'},
            editable: false, valueFormatter: this.currencyFormatter },
