...
export class BillerDialogComponent implements OnInit {
    ...
    colDefs = [
        ...
        { headerName: 'Buy Price', field: 'buyPrice', width: 125, cellStyle: {textAlign: 'right'}, valueFormatter: this.currencyFormatter },
    ...
    nonColDefs = [
        ...
        { headerName: 'Sell Price', field: 'salesPrice', width: 100, cellStyle: {textAlign: 'right'},
        valueFormatter: this.currencyFormatter },
        { headerName: 'Profit', field: 'profit', width: 100, cellStyle: {textAlign: 'right'}, valueFormatter: this.currencyFormatter },
